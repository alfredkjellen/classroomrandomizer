  ...
  <div class="drawer">
    ...
    <div class="drawer-side">
      ...
      <ul class="menu p-4 w-80 min-h-full bg-base-200 text-xl sm:text-lg">
        ...
        <li>
          <a on:click={closeDrawer} href="/randomizeroom"
            ><svg
              class="w-6 h-6 text-gray-800 dark:text-white"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
            ...
            >
              <path
                ...
                clip-rule="evenodd"
              />
            </svg>Randomize classroom</a
          >
        </li>
        <li>
          <a on:click={closeDrawer} href="/randomizegroups"
            ><svg
              class="w-6 h-6 text-gray-800 dark:text-white"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
            ...
            >
              <path
                ...
                clip-rule="evenodd"
              />
            </svg>Randomize groups</a
          >
        </li>
        <li>
          <a on:click={closeDrawer} href="/editclassrooms"
            >{#if $themeStore === "darktheme"}
              <svg
                class="w-6 h-6 text-gray-800 dark:text-white"
                aria-hidden="true"
            ...
            {/if}Edit classrooms</a
          >
        </li>
        <li>
          <a on:click={closeDrawer} href="/editclasses"
            >{#if $themeStore === "darktheme"}
              <svg
                class="w-6 h-6 text-gray-800 dark:text-white"
                aria-hidden="true"
