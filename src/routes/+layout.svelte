...
<html lang="ts" data-theme={$themeStore}>
  <nav class="navbar justify-between bg-base-200 h-0.5">
    <ul class="hidden menu sm:menu-horizontal">
      ...
      <a class="btn link-hover" href="/randomizeroom"
        ><svg
      ...
      >
      <a class="btn link-hover" href="/randomizegroups"
        ><svg
          class="w-6 h-6 text-gray-800 dark:text-white"
          aria-hidden="true"
          xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="dropdown sm:hidden">
      ...
      <ul
        tabindex="0"
        class="menu menu-lg dropdown-content mt-3 z-[1] p-2 shadow bg-base-200 rounded-box w-72 font-bold gap-2 mb-10 outline-neutral outline"
      >
        <li><a href="/"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke={$svgColor}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg>Home</a></li>
        <li><a href="/randomizeroom"><svg
          class="w-6 h-6 text-gray-800 dark:text-white"
          aria-hidden="true"
          xmlns="http://www.w3.org/2000/svg"
          width="24"
        ...
        <li><a href="/editclassrooms">{#if $themeStore === "darktheme"}
          <svg
            class="w-6 h-6 text-gray-800 dark:text-white"
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
        ...
        <li><a href="/editclasses">{#if $themeStore === "darktheme"}
          <svg
            class="w-6 h-6 text-gray-800 dark:text-white"
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
        ...
        <LoginButton size="xl btn-circle btn-wide" svgColor={$svgColor}></LoginButton>

        <SignupButton size="xl btn-circle btn-wide"></SignupButton>
      </ul>
    </div>
