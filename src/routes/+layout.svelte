...
<html lang="ts" data-theme={$themeStore}>
  <nav class="navbar justify-between bg-base-200 h-0.5">
    ...
    <div class="dropdown lg:hidden">
      ...
      >
        <li><a href="/"><svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill={$svgColor} viewBox="0 0 24 24">
